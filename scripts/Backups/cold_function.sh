Gera_cmd_bd_rman_cold ()
{
     ...
     # Inicio da geracao do arquivo de comandos do rman.
     {
		...
		echo "sql 'alter system register'"
        echo "exit;"
     }  > $ARQ_CMD_RMAN_BD
}
