...
echo "Descricao..:Backup lógico (export) da partição de $MES_COM de $ANO_COM da tabela ${OWN}.${TAB}."
echo "Arquivos...:"
echo "-------------------------------"
ls -ltr ${ARQ}
echo "-------------------------------"
...
echo "1-) Remover os arquivos copiados para liberar espaço em disco."
