...
echo "Descricao..:Backup lógico (export) da partição de $MES_COM de $ANO_COM da tabela acct.trr_movimentos (accounting)."
echo "Arquivos...:"
echo "-------------------------------"
ls -ltr ${DIR_DMPS}/MENORQ_${PAR}*dmp*
echo "-------------------------------"
echo "!!! Importante !!!"
echo "Apos morto efetuado, os arquivos DEVEM SER REMOVIDOS da `hostname` para liberar espaço em disco."
echo "Obrigado."
} > $MAIL
