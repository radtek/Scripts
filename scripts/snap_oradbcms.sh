## crontab
## */5 * * * * /home/oracle/ilegra/snap/snap.sh oradbcms2 > /tmp/snap.out
...
#Remove logs com mais de 10dias
find $DIR_LOG -name 'snap*.log' -ctime +10 -exec rm -f {} \;
...
select /*+ rule */  sid, job, to_char(this_date, 'dd-mm-yyyy hh24:mi:ss')
