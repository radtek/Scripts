...
select /*+ rule */ 
       proc.spid OSPID, s.INST_ID, s.sid,s.username,s.osuser, s.machine, s.logon_time,w.seconds_in_wait as "SEC WAIT",w.event,substr(w.p1text,1,9) p1text,w.p1,
       w.p2text,w.p2,w.p3text,w.p3,s.sql_hash_value,s.program,to_char(s.logon_time, 'dd/mm/rrrr hh24:mi') logon_time, 
