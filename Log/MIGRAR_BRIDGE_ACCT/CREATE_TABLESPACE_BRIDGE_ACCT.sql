set lines 2000
PROMPT EXECUTAR NA ORADB1 PEGAR O OUTPUT E EXECUTAR NO USDB3, ALTERADO OS PATHS
PROMPT
SELECT DECODE(DF.FILE_ID, TBS.MIN_file_id, 'CREATE', 'ALTER') || ' TABLESPACE ' || TBS.tablespace_name || 
	   ...
	   DECODE(MAXBYTES, 0, ';', ' MAXSIZE ' || TO_CHAR(ROUND(MAXBYTES  / 1024, 0)) || 'K;')
