...
drop materialized view log on tarefa; 
drop materialized view log on responsavelentidade; 
drop materialized view log on hora_planejada; 
drop materialized view log on horatrabalhada; 
drop materialized view log on hora_alocada; 
drop materialized view log on dia; 
