...
COMPUTE AVG MIN MAX OF "00" on REPORT
COMPUTE AVG MIN MAX OF "01" on REPORT
COMPUTE AVG MIN MAX OF "02" on REPORT
COMPUTE AVG MIN MAX OF "03" on REPORT
COMPUTE AVG MIN MAX OF "04" on REPORT
COMPUTE AVG MIN MAX OF "05" on REPORT
COMPUTE AVG MIN MAX OF "06" on REPORT
COMPUTE AVG MIN MAX OF "07" on REPORT
COMPUTE AVG MIN MAX OF "08" on REPORT
COMPUTE AVG MIN MAX OF "09" on REPORT
COMPUTE AVG MIN MAX OF "10" on REPORT
COMPUTE AVG MIN MAX OF "11" on REPORT
COMPUTE AVG MIN MAX OF "12" on REPORT
COMPUTE AVG MIN MAX OF "13" on REPORT
COMPUTE AVG MIN MAX OF "14" on REPORT
COMPUTE AVG MIN MAX OF "15" on REPORT
COMPUTE AVG MIN MAX OF "16" on REPORT
COMPUTE AVG MIN MAX OF "17" on REPORT
COMPUTE AVG MIN MAX OF "18" on REPORT
COMPUTE AVG MIN MAX OF "19" on REPORT
COMPUTE AVG MIN MAX OF "20" on REPORT
COMPUTE AVG MIN MAX OF "21" on REPORT
COMPUTE AVG MIN MAX OF "22" on REPORT
COMPUTE AVG MIN MAX OF "23" on REPORT
...
ORDER BY to_char(COMPLETION_TIME,'YYYY-MON-DD');
